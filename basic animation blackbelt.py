# -*- coding: utf-8 -*-
"""
Created on Thu Mar 21 16:36:21 2024
...
class Charlie(pygame.sprite.Sprite):
    ...
    def changeimage(self):
        fileName = ("giraffe.png", "monkey.png", "hippo.png", "panda.png", "parrot.png", "penguin.png", "pig.png", "rabbit.png", "snake.png")
        randNum = random.randrange(len(fileName))
        
        self.image = pygame.image.load(fileName[randNum])
        self.image.convert_alpha()
        self.image = pygame.transform.scale(self.image, (50, 50))
